...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        DinnerDao.createTable(db, ifNotExists);
    ...
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        DinnerDao.dropTable(db, ifExists);
        DinnerStatDao.dropTable(db, ifExists);
        IngredientDao.dropTable(db, ifExists);
        DinnerIngredientDao.dropTable(db, ifExists);
    }
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(DinnerStatDao.class);
        registerDaoClass(IngredientDao.class);
        registerDaoClass(DinnerIngredientDao.class);
    }
